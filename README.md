...
6. Create .env file and fill it with the config from .env.example 
7. Type `php artisan key:generate` in the project terminal
8. Type `php artisan migrate` in the project terminal
9. Type `php artisan serve` in the project terminal
10. Done
```

...
<div class="container d-flex justify-content-center">
    <div class="box-login box-register shadow mt-4 mb-4 me-3 ms-2">
        ...
        <form action="" class="mt-3">
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="fName" aria-describedby="fNameHelp" placeholder="Enter Firts Name">
                    </div>
                    <div class="mb-3">
            ...
            <div class="mt-4">
                <button type="button" class="btn btn-secondary fw-bold shadow-sm text-primary w-100 btn-register">REGISTER</button>
            </div>
        </form>
    </div>
</div>

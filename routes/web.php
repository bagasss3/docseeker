...
Route::post('/login-admin', [AuthController::class, 'authenticateAdmin'])->name(
    'authenticateAdmin'
);
...
Route::get('/admin/dashboard', [AdminController::class, 'dashboard']); //->middleware(['auth','is_admin']);
Route::get('/admin/product', [AdminController::class, 'index']); //->middleware(['auth','is_admin']);
Route::get('/admin/product/{id}', [AdminController::class, 'show']); //->middleware(
